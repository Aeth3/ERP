...
import com.maiu.erp.modules.inventory.application.dto.UpdateWarehouseRequest;
...
public class WarehouseController {
    ...
    public ResponseEntity<IdResponse> createWarehouse(
        ...
        Warehouse warehouse = toModel(request);
    ...
    public ResponseEntity<Void> updateWarehouse(
        ...
        warehouseService.updateWarehouse(id, toModel(request));
    ...
    private Warehouse toModel(CreateWarehouseRequest request) {
    ...
    private Warehouse toModel(UpdateWarehouseRequest request) {
        Warehouse warehouse = new Warehouse();
        warehouse.setCode(request.code());
        warehouse.setName(request.name());
        warehouse.setAddress(request.address());
